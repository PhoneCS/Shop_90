...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2025 at 11:47 PM
...
(3, 'กระเป๋า', 'สวยมาก', '2025-03-28 04:50:31', '2025-03-28 04:50:31', 'product4.jpg'),
...
(22, 1, 16, 1, '2025-03-29 22:32:21', '2025-03-29 22:32:50', 'n'),
(23, 1, 17, 1, '2025-03-29 22:32:23', '2025-03-29 22:32:52', 'n');
...
INSERT INTO `products` (`product_id`, `product_name`, `product_image`, `product_image_hover`, `product_price`, `original_price`, `product_description`, `product_rating`, `product_discount`, `product_stock`, `category_id`) VALUES
(16, 'กระเป๋าสีขาว', 'product4_hover.jpeg', 'product4_1.jpg', 100.00, 50.00, 'TAIDU กระเป๋าสะพายไหล่ กระเป๋าสะพายข้างวินเทจยุค 90\'s สุดเท่ วัสดุโพลีเอสเตอร์ ความจุขนาดใหญ่', 0.0, 50.00, 100, '2'),
(17, 'เสื้อยืดลายกราฟิก', 'product3_2.jpg', 'product3_hover.jpg', 90.00, 50.00, 'เสื้อวินเทจยุค90  SMELLS LIKE โครตเท่(ส่งเร้ว )✅ของแท้100%', 0.0, 44.44, 500, '1'),
(20, 'เทปเพลงครูในดวงใจ', 'f599936357c2dc7f745cf84990691192.jpg', 'birhb5.jpg', 120.00, NULL, 'เทปเพลงมือ2สภาพดีผ่านการเทสเสียงแล้วทุกม้วนก่อนลงขายคับ\r\n\r\nปกและม้วนสภาพสวย สนใจเลือกซื้อไปฟังไปสะสมกันได้เลยคาบซื้อกับเรามั่นใจได้ในคุณภาพสินค้าและบริการหลังการขาย \r\nสนใจสอบถามรายละเอียดเกี่ยวกับสินค้าแชทมาได้เลยนะค้าบ\r\nจะรีบเข้ามาตอบครับ', 0.0, 0.00, 20, '3'),
(21, 'เทปเพลงคาราบาวอัลบั้ม วณิพก', 'yd.jpg', 'ja.jpg', 120.00, NULL, 'ขายเทปเพลง เพลงเพื่อชีวิต\r\nอัลบั้ม : ‪วณิพก\r\nนักร้อง : คาราบาว\r\nคุณภาพ : มีปกเทป มีม้วนเทป ทดสอบเสียงแล้วปกติพร้อมฟัง\r\n- สินค้าได้ทำการตรวจเช็คคุณภาพของเสียงให้อยู่ในสภาพพร้อมใช้งาน\r\n- ได้ทำการซีลพลาสติกเพื่อป้องกันฝุ่น', 0.0, 0.00, 20, '3'),
(22, 'เทปเพลงเพื่อชีวิต คาราบาว ชุด กินใจ', 'd3.jpg', '8k.jpg', 120.00, NULL, 'เทปคาสเซ็ท สภาพดี ตลับเทปตรงกับปกกล่องเทป\r\nเจ้าของร้านได้ตรวจดูด้วยสายตาทุกม้วน เส้นเทปไม่ขาด\r\nตัวตลับเทปไม่แตกหัก อยู่สภาพสมบูรณ์\r\nตัวกล่องเทปอาจจะมีรอยร้าว ขีดข่วนบ้างตามสภาพที่ผ่านมา\r\nเจ้าของร้านไม่มีเครื่องที่จะทดลองฟัง ทำให้ไม่สามารถรู้ได้ว่าเสียงของเพลงในเทปจะเป็นเช่นไร  แนะนำให้เก็บสะสมเท่านั้น ไม่สามารถรับรองเรื่องของคุณภาพเสียงได้ครับ', 0.0, 0.00, 20, '3'),
(23, 'เสื้อวง Kiss ปี 2010 Size S สินค้าลิขสิทธิ์แท้ 100%', 'um.jpg', 'vf.jpg', 1200.00, NULL, '	\r\nKiss ปี 2010 Size S อก 19.5“ ยาว 27” ผ้าคอตต้อน 100 เข็บคู่ ไม่มีข้าง สภาพ 100% ป้ายคอ Ten', 0.0, 0.00, 5, '1'),
(24, 'เสื้อวง AC-DC ลิขสิทธิ์แท้100%', 'l4.jpg', '2x.jpg', 1100.00, 1000.00, 'เสื้อวง AC-DC ลิขสิทธิ์แท้100%\r\n\r\nป้ายGildan\r\nปี 2017\r\nSize พร้อมส่ง\r\nS อก18”ความยาว28”\r\nM อก20”ความยาว29”\r\nL อก22”ความยาว30”\r\nXl อก24”ความยาว31”', 0.0, 9.09, 5, '1'),
(25, 'เสื้อวง DEF LEPPARD ลิขสิทธิ์แท้100%', 'uw.jpg', 'z6.jpg', 950.00, NULL, 'เสื้อวง DEF LEPPARD ลิขสิทธิ์แท้100%\r\nป้าย Gildan\r\nSize พร้อมส่ง\r\nM อก20” ความยาว29”\r\nL อก22” ความยาว30”\r\nXL อก24”ความยาว30.5”', 0.0, 0.00, 5, '1'),
(26, 'เก้าอี้ตัดผมโบราณ หลังกลม ยุคพระนคร', '462920691_8470437399703916_8220377031588916959_n.jpg', '463033316_8470437379703918_6538883070512336489_n (2).jpg', 15200.00, NULL, 'เก้าอี้ตัดผมชาย หลังกลม ในยุคของพระนคร', 0.0, 0.00, 1, '4'),
(27, 'ตะเกียงเจ้าพายุ', '7m.jpg', '6u.jpg', 890.00, NULL, 'ขนาดเล็ก\r\n\r\nสูง 7 นิ้ว \r\n\r\nกว้าง 5 นิ้ว\r\n\r\n- เป็นของใหม่\r\n\r\n- สามารถ ใช้งาน จุดไฟ ได้จริงๆ\r\n\r\n- เติมน้ำมันได้จริง\r\n\r\n- เปลี่ยนใส้ได้\r\n\r\n- วัสดุเป็นโลหะ\r\n\r\n- ประดับ ตกแต่ง ของแต่งบ้าน ร้าน โรงแรม รีสอร์ท แนวของเก่าโบราณ วินเทจ Vintage', 0.0, 0.00, 3, '4'),
(28, 'ทามาก๊อต', 'o6zyqfb5cfy4Eg1OphM-o.jpg', 'o70fsg6b4TR6dq0QXVD-o.jpg', 120.00, NULL, 'ทามาก๊อตของเล่นยุค90', 0.0, 0.00, 80, '5'),
(29, 'หมากฝรั่ง บุหรี่ตราแมวดำ', 'b2ed0c0d7c8675d631b5612d46f1bdd6.jpg', 'images.jpg', 10.00, NULL, 'เด็กไทยที่รู้จักมานี ก็คงต้องรู้จักหมากฝรั่งแมวดำอันนี้เป็นแน่แท้ แม้ว่าเราจะห่างกับมานีมานะมาเเล้วแสนไกล แต่รู้หรือไม่ อีบุหรี่แมวดำนี่ก็ยังผลิตมาอย่างต่อเนื่อง ไม่เชื่อก็ดูวันหมดอายุสิ', 0.0, 0.00, 200, '5'),
(30, 'จานสังกะสีเคลือบ สีขาว (แบบยกโหล)', '4g.jpg', '50.jpg', 400.00, 200.00, 'จานสังกะสีเคลือบ8 (20ซม.) กระต่าย /ยกโหล 12 ใบ\r\nEnamelware เป็นเครื่องครัวแบบอเมริกันที่สร้างขึ้นในยุค 1870 ทำจากเหล็กคุณภาพสูงจากนั้นเคลือบด้วยแก้วในเตาอบที่ร้อนมาก การเคลือบ Enamel เป็นการเคลือบ ที่ทำใส่อนุภาคของแก้วลงไปบนผิวของภาชนะโลหะ ทำให้ได้ผิวที่เรียบลื้น, ไม่ติดและไม่ไม่ทำปฏิกริยากับอาหาร ภาชนะที่เคลือบ Enamel ปลอดภัยต่อสุขภาพ, สวยงาม และทนต่อความร้อนสูงได้ดี เนื่องจากเนื้อ Enamel นั้นเรียบสนิทไม่ค่อยมีรูพรุ่นทำให้ทำความสะอาดแล้วมีคราบอาหารหรือเชื้อโรคตกค้างน้อยมาก\r\nข้อด้อยของ Enamel ก็คืออาจจะกระเทาะได้ เพราะ Enamel คือการเคลือบด้วยแก้วจึงไม่ทนต่อการกระแทก แต่ถ้าได้รับการดูแลดีๆ ภาชนะเคลือบ enamel นี่จะทนชั่วลูกชั่วหลานแบบที่เราเคยเห็นคนรุ่นพ่อรุ่นแม่เราใช้แน่นอน\r\n', 0.0, 50.00, 700, '4'),
(31, 'ช้อนสังกะสี (สีเขียว แบบ โหลนึง)', '07291a63-46c6-43cb-a68a-6f378bfd5ca9.jpg', 'e8705fe0-ef3a-4a3e-a444-51d890fcace2.jpg', 300.00, NULL, 'ช้อนสังกะสี (สีเขียว) แบบบาง เป็นของเก่าเก็บ ไม่ผ่านการใช้งาน เริ่มหายากขึ้นทุกวัน มีไม่มาก', 0.0, 0.00, 90, '4'),
(32, 'เตารีดเตาถ่าน', 'S31a8a534e72f4c298ff01bec85bf5140b.jpg', 'Sb8258daacff84c83805364a38ea9e62dd.jpg', 350.00, NULL, 'เตารีดแบบโบราณ ใช้รีดผ้าของคนสมัยก่อน', 0.0, 0.00, 5, '4'),
(34, 'เสื้อยืดลายกราฟิก2', '07291a63-46c6-43cb-a68a-6f378bfd5ca9.jpg', '67e85f17b5252.jpg', 100.00, 50.00, 'กฟมาd', 0.0, 50.00, 1100, '1');
