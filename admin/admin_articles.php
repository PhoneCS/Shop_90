...
<body>
    <div class="container mt-4">
        ...
        <?php if ($isAdmin): ?>
            <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addArticleModal">เพิ่มบทความ</button>
        <?php endif; ?>
        ...
        <div class="article-list">
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="article d-flex mb-4">
                    <!-- รูปภาพ -->
                    <?php if ($row['image']): ?>
                        <img src="../assets/image/<?= $row['image'] ?>" alt="Article Image" class="img-fluid" style="max-width: 150px; margin-right: 20px;">
                    <?php endif; ?>
                    ...
                    <div class="modal-body">
                        <form id="editArticleForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name="image">
                                <img id="currentImage" src="" alt="Current Image" style="max-width: 100%; margin-top: 10px;">
                            </div>
